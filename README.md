...
Covid-19 est une application affichant les nombres totaux de personnes ayant été confirmées comme nouveaux cas victimes du Coronavirus, les personnes décédées suite au virus et les personnes guéries. Aussi, on peut recueillir le détail par pays de ces nombres.
